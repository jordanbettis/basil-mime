...
-- PROJECT CONTEXT:
--
--  This package is an instantiation of a list of header objects, for
--  subclassing into the Basil.Headers.Lists package
--
-------------------------------------------------------------------------------

with Ada.Containers.Doubly_Linked_Lists;

package Basil.Headers.Abstract_Lists is
   new Ada.Containers.Doubly_Linked_Lists
  (Element_Type => Basil.Headers.Header,
     "="        => Basil.Headers.Are_Equal);
