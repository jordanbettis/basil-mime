...
-- PROJECT CONTEXT:
--
--  This package provides a list of message header objects, and the
--  operations to parse and compile structured header values that
--  contain one or more message IDs.
--
-------------------------------------------------------------------------------

with Ada.Containers;

with Basil.Message_ID_Headers.Abstract_Lists;

with Basil.Strings;                   use Basil.Strings;
with Basil.Headers;                   use Basil.Headers;
with Basil.Headers.Lists;

package Basil.Message_ID_Headers.Lists is

   --  Derived from the tagged type to bring in the Ada DLL Container
   --  operations.
   type List is
     new Basil.Message_ID_Headers.Abstract_Lists.List with null record;
   ...
   --  Basil.Message_ID_Headers.Abstract_Lists.
   subtype Cursor is Basil.Message_ID_Headers.Abstract_Lists.Cursor;

   No_Element : constant Cursor;

   function Element     (Position : in     Cursor) return Message_ID_Header
     renames Basil.Message_ID_Headers.Abstract_Lists.Element;

   procedure Query_Element
     (Position : Cursor;
      Process  : not null access procedure (Element : in Message_ID_Header))
     renames Basil.Message_ID_Headers.Abstract_Lists.Query_Element;

   function Next        (Position : in     Cursor) return Cursor
     renames Basil.Message_ID_Headers.Abstract_Lists.Next;

   procedure Next       (Position : in out Cursor)
     renames Basil.Message_ID_Headers.Abstract_Lists.Next;

   function Previous    (Position : in     Cursor) return Cursor
     renames Basil.Message_ID_Headers.Abstract_Lists.Previous;

   procedure Previous   (Position : in out Cursor)
     renames Basil.Message_ID_Headers.Abstract_Lists.Previous;

   function Has_Element (Position : in     Cursor) return Boolean
     renames Basil.Message_ID_Headers.Abstract_Lists.Has_Element;
   ...
   function Compile (Message_IDs : in List) return Headers.Lists.List;
...
private
   ...
   No_Element : constant Cursor
     := Basil.Message_ID_Headers.Abstract_Lists.No_Element;
